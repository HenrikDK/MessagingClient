...
public static class ClientExtensions
{
    ...
    public static Type GetHandlerType<T>(this IMessageHandler<T> handler) where T : class, IMessage
    {
        return typeof(T);
    }
    ...
    /// <returns></returns>
    public static MessageConsumer Register<T>(this MessageConsumer consumer, IMessageHandler<T> handler, string messageName = null) where T: class, IMessage
    {
